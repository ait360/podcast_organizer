...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            ...
            help='Specifies the login for the users.',
        )
        parser.add_argument(
    ...
    def handle_non_interactive(self, username, verbose_field_name, database, user_data, **options):
        ...
        # options.
        if username is None:
            username = os.environ.get('DJANGO_USER_' + self.User.USERNAME_FIELD.upper())
        if username is None:
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            self.User._default_manager.db_manager(database).create_user(**user_data)
            ...
            self.stdout.write(
                'users creation skipped due to not running in a TTY. '
